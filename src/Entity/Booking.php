...
class Booking
{
    ...
    public function isBookableDates()
    {
        ...
        // 2. Comparer les dates choisi avec les dates impossibles
        $bookingDays = $this->getDays();

        // Petite fonction anonym
    ...
    /**
     * Permet de récupérer un taleau des journées qui correspondent à ma  réservation 
     *
