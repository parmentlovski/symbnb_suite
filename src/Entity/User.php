...
class User implements UserInterface
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Email(message="Veuillez renseignez un email valid")
     */
    private $email;

    /**
     * @ORM\Column(type="string", length=255, nullable=true)
     * @Assert\Url(message="Veuillez renseigner une adresse mail valide pour votre avatar")
     */
    private $picture;
    ...
    /**
     *@Assert\EqualTo(propertyPath="hash", message="Votre mot de passe n'est pas le même")
     */
